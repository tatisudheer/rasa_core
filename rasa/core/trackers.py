...
from rasa.core.constants import DEFAULT_INTERACTIVE
...
class DialogueStateTracker(object):
    ...
    def from_dict(
        ...
        return cls.from_events(sender_id, request_id, user_id, evts, slots, max_event_history)
    ...
    def from_events(
        ...
        tracker = cls(sender_id, request_id, user_id, slots, max_event_history)
        for e in evts:
            tracker.update(e)
        return tracker

    def __init__(self, sender_id, request_id, user_id, slots, max_event_history=None):
    ...
    def init_copy(self) -> "DialogueStateTracker":
        ...
        return DialogueStateTracker(
            UserMessage.DEFAULT_SENDER_ID, UserMessage.DEFAULT_REQUEST_ID, UserMessage.DEFAULT_USER_ID, self.slots.values(), self._max_event_history
        )
    ...
    def _set_slot(self, key: Text, value: Any) -> None:
        ...
        if key in self.slots:
            ...
            if str(self.request_id) != DEFAULT_INTERACTIVE:
                logger.error(
